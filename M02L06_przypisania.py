...
####### rozwiaznie
currency = "usd"
#wartość zmiennej currency nie zmienia się na wielkie litery, ponieważ metoda upper() zwraca nowy ciąg znaków z przekształceniem na wielkie litery, ale nie modyfikuje zmiennej currency bezpośrednio. Należy przypisać wynik currency.upper() z powrotem do currency
