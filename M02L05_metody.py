...
#  Moje rozwizanie
# print("Generator nazw użytkownika")
# def generuj_username(imie_nazwisko):
#     # Tworzymy tablicę translacji dla zamiany spacji na podkreślenie
#     tablica_translacji = str.maketrans(" ", "_")
#     # Zmieniamy spacje na podkreślenia, stosujemy małe litery
#     return imie_nazwisko.translate(tablica_translacji).lower()
# # Pobieranie imienia i nazwiska od użytkownika
# imie_nazwisko = input("Jak się nazywasz? ")
# # Generowanie username
# username = generuj_username(imie_nazwisko)
# print("Twoja nazwa użytkownika to:", username)

#Proste rozwiązanie
print("Generator nazw użytkownika")
raw_username = input("Podaj nazwę użytkownika: ")
username = raw_username.lower().replace(" ","_")
#username = raw_username.replace(" ","_").lower
print(username)
# text. Ctrl + space - pokaże metody po kropce.