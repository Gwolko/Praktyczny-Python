...
# 4. Jeżeli plik wyjściowy 
# już istnieje, to go nie nadpisuj. W tym celu trzeba wykorzystać funkcję open w inny sposób. Jak? Znajdź w dokumentacji tej funkcji!

input_filename=input('Podaj nazwę pliku wejsciowego:  ')
output_filename=input('Podaj nazwę pliku wyjsciowego:  ')
